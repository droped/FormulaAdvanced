...
function gc_clipRect(gc, what, x, y, w, h)
 ...
 if x and y and w and h then
  clipRectData.current = {x=x,y=y,w=w,h=h}
 end
end
...
function Screen:screenLoseFocus()
end

function Screen:screenGetFocus()
end
...
function Screen:mouseDown()
end

function Screen:mouseUp()
end

function Screen:mouseMove()
end

function Screen:contextMenu()
end

function Screen:appended()
end
...
function WidgetManager:mouseDown(x, y) 
 ...
 if n then
  if self.focus~=0 and self.focus~=n then
   self:getWidget().hasFocus = false self:getWidget():loseFocus()
  end
  self.focus	=	n
...
function on.arrowKey(arrw)
 current_screen():arrowKey(arrw)
end
...
function on.escapeKey()
 current_screen():escapeKey()
end

function on.tabKey()
 current_screen():tabKey()
end

function on.backtabKey()
 current_screen():backtabKey()
end
...
function on.contextMenu()
 current_screen():contextMenu()
end

function on.mouseDown(x,y)
 current_screen():mouseDown(x,y)
end
